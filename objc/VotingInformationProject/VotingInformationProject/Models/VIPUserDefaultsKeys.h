//
//  VIPUserDefaultsKeys.h
//  VotingInformationProject
//
//  Created by Andrew Fink on 1/24/14.
//  
//
...
#define USER_DEFAULTS_SITE_FILTER_KEY @"votinginfo.siteFilterKey"
#define USER_DEFAULTS_DIRECTIONS_TYPE_KEY @"votinginfo.directionsTypeKey"
